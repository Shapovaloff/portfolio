...
/* harmony import */ var _modules_scroll_to_element__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/scroll-to-element */ "./js/modules/scroll-to-element.js");
/* harmony import */ var _vendor_smoothscroll_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./vendor/smoothscroll.js */ "./js/vendor/smoothscroll.js");
/* harmony import */ var _vendor_smoothscroll_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_vendor_smoothscroll_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_toggle_menu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/toggle-menu */ "./js/modules/toggle-menu.js");
/* harmony import */ var _modules_portfolio_filter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/portfolio-filter */ "./js/modules/portfolio-filter.js");
/* harmony import */ var _modules_card_view__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/card-view */ "./js/modules/card-view.js");
...
/* harmony import */ var _modules_experience_count_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/experience-count.js */ "./js/modules/experience-count.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_experience_count_js__WEBPACK_IMPORTED_MODULE_9__["default"])();
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_toggle_menu__WEBPACK_IMPORTED_MODULE_5__["default"])();
  _modules_custom_select__WEBPACK_IMPORTED_MODULE_8__["default"].init();
  Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
  Object(_modules_portfolio_filter__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(_modules_scroll_to_element__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_card_view__WEBPACK_IMPORTED_MODULE_7__["default"])();
  _vendor_smoothscroll_js__WEBPACK_IMPORTED_MODULE_4___default.a.polyfill();
...
var initCardViewAction = function initCardViewAction(cardParent) {
  ...
  var cardList = cardParent.querySelector('[data-card-view="list"]');
  buttons.forEach(function (btn) {
...
/***/ "./js/modules/experience-count.js":
/*!****************************************!*\
  !*** ./js/modules/experience-count.js ***!
  \****************************************/
/*! exports provided: default */
...
var declination = function declination(numb) {
  var name = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'years';
  var worlds = declinationText[name];
...
var experienceCount = function experienceCount() {
  var allText = document.querySelectorAll("[data-experience='text']");
  if (!allText.length) return;
  var allMonth = monthDiff(new Date(2020, 8), new Date());
  var countYears = parseInt(allMonth / 12);
  var countMonth = allMonth % 12;
  var stringYears = countYears > 0 ? "".concat(countYears, " ").concat(declination(countYears, 'years')) : '';
  var stringMonth = countMonth > 0 ? "".concat(countMonth, " ").concat(declination(countMonth, 'month')) : '';
  var text = "".concat(stringYears).concat(stringYears && stringMonth && ' и ').concat(stringMonth);
  allText.forEach(function (item) {
    return item.textContent = text;
  });
};
/* harmony default export */ __webpack_exports__["default"] = (experienceCount);
...
/***/ "./js/modules/portfolio-filter.js":
/*!****************************************!*\
  !*** ./js/modules/portfolio-filter.js ***!
  \****************************************/
/*! exports provided: default */
...
isloadBtn();
var initFilter = function initFilter(filterItems) {
  window.setClass = function (btnCategory) {
